...
-- cria CombatFramework fake
if not ps:FindFirstChild("CombatFramework") then
    local fakeCF = Instance.new("Folder")
    fakeCF.Name = "CombatFramework"
    fakeCF.Parent = ps

    -- cria subpastas comuns pra evitar mais erros
    Instance.new("Folder", fakeCF).Name = "Client"
    Instance.new("Folder", fakeCF).Name = "Shared"
end

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/OrionLibray/Orion/main/source.lua')))()
